...
namespace LudumDare50.EditorScripts {
    public static class CustomBuilders {
        public static void BuildWebGL() {
            ...
            int index = Array.IndexOf(arguments, "LudumDare50.EditorScripts.CustomBuilders.BuildWebGL");
        ...
        public static void BuildAndroid() {
            string[] arguments = Environment.GetCommandLineArgs();
            int index = Array.IndexOf(arguments, "LudumDare50.EditorScripts.CustomBuilders.BuildAndroid");
            if (index < 0 || index >= arguments.Length - 1) {
